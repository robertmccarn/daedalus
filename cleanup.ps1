...
$requiredFiles = @(
    ...
    "game\State\Phase3Models.cs",
    "game\StaticUnit.cs",
    "game\Systems\InventorySystem.cs",
    "game\Systems\UpkeepSystem.cs",
    "game\Systems\ExtractionSystem.cs",
    "game\Systems\SynthesisSystem.cs",
    "game\Systems\ExpeditionRewardSystem.cs",
    "ui\BattleSystem.cs",
    "ui\GameWindow.cs",
    "ui\GameRenderer.cs",
